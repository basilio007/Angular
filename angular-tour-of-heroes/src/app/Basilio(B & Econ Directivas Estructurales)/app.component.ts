...
export class AppComponent {
  ...
  toggleEdit(character: Character): void {
    character.editable = !character.editable;
    if (!character.editable) {
    
      console.log('Saved changes:', character);
    }
  }
  

  toggleVisibility(character:Character) {
    character.mostrarElementos = !character.mostrarElementos;
    if (!character.mostrarElementos) {
